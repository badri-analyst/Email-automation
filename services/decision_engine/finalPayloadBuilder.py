...
class FinalPayloadBuilder:
    ...
    def _candidate(profile: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "youtube_url": profile.get("youtubeUrl") or profile.get("youtube_url") or profile.get("youtube_video_url") or "",
            "portfolio_url": profile.get("portfolioUrl") or profile.get("portfolio_url") or (profile.get("portfolio_links") or [""])[0] or "",
